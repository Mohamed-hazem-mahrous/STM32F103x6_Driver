...
typedef struct
{
	...
	uint8_t				Trigger_Case;		// Specifies The Rising or Falling Trigger or Both
											// this parameter must be based on @ref EXTI_Trigger_Define

	uint8_t				IRQ_EN;				// Enable or Disable the EXTI IRQ (that will enable the IRQ Mask and also the NVIC Interrupt Controller)
